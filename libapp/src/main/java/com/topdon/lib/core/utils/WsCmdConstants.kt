...
object WsCmdConstants {
    ...
    const val AR_COMMAND_STORAGE_DELETE_FILE: String = "AR_COMMAND_STORAGE_DELETE_FILE"  //delete文件
    ...
    const val AR_COMMAND_SET_KEY_CAPTURE_FUNC: String = "AR_COMMAND_SET_KEY_CAPTURE_FUNC"//photo键长按功能
    const val AR_COMMAND_GET_KEY_CAPTURE_FUNC: String = "AR_COMMAND_GET_KEY_CAPTURE_FUNC"
    const val AR_COMMAND_SET_CONTINUOUS_SHOOTING: String = "AR_COMMAND_SET_CONTINUOUS_SHOOTING" //settings连续photo
    ...
    const val AR_COMMAND_VRECORD: Int = 104 //video开始或结束
    const val AR_COMMAND_RECORD_STATUS_GET: String = "AR_COMMAND_RECORD_STATUS_GET"//获取video状态
