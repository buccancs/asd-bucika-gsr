 ...
 * .
 ...
 val pageSize = 1024 * 1024 * 10 //10M
        ...
        try {
            ...
            var packNum = 0
            var hasReadCount = 0
 var byteArray = ByteArray(pageSize)//10M
 ...
 if (code != 200) {//200
                    ...
                    hasReadCount = 0
 byteArray = ByteArray(pageSize)//10M
                }
