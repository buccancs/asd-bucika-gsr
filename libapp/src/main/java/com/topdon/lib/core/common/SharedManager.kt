 ...
 * true- false-
    ...
    /**
 * thermal imaging-Observation mode-photo.
 * true- false-
     */
 ...
 * true- false-
 ...
 private const val LANGUAGE = "language"//settings
 ...
 private const val DEVICE_VERSION = "deviceVersion"//
    ...
    temperature
 private const val SP_CUSTOM_PSEUDO = "sp_custom_pseudo"//pseudo color
 private const val SP_TARGET_POP = "sp_target_pop" //target
 ...
 private const val SP_CHANGE_DEVICE = "sp_change_device" //ts001ts004
 private const val SP_TC007_CUSTOM_PSEUDO = "sp_tc007_custom_pseudo"//tc007pseudo color
 ...
 * targetpage
 ...
 private const val IR_DUAL_DISP = "ir_dual_disp"//dual light-
 private const val IR_DUAL_DISP_V = "ir_dual_disp_v"//dual light-
 ...
 * TS004page-
    ...
    /**
 * TS004TS001 device 0: 1:TS001 2:TS004
     */
