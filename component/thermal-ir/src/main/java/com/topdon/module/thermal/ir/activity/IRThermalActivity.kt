...
// updateTemperatureSeekBar(false,R.drawable.ic_edit_pseudo_lock_svg,"lock")//
...
// updateTemperatureSeekBar(true,R.drawable.ic_edit_pseudo_unlock_svg,"unlock")//
//            } else {
//                setDefLimit()
// updateTemperatureSeekBar(false,R.drawable.ic_edit_pseudo_lock_svg,"lock")//
//            }
...
// private var rotateAngle = DeviceConfig.ROTATE_ANGLE //angle0
...
// // 
// setTemp(-2)//deletepoint line area
//                setZoom()
//            }
...
// thermal_recycler.colorBarStats = 441 //pseudo color
//        }else{
//            cl_seek_bar.visibility = View.GONE
// thermal_recycler.colorBarStats = 440 //pseudo color
//        }
//        temperature_seekbar?.setPseudocode(pseudocolorMode)
//        if (customPseudoBean!=null && customPseudoBean.isUseCustomPseudo){
//            temperature_seekbar.setColorList(customPseudoBean.getColorList()?.reversedArray()?:null)
...
//        val seekBar = contentView?.findViewById<CommSeekBar>(R.id.seek_bar)
//        val tvProcess = contentView?.findViewById<TextView>(R.id.tv_value)
// // AGCMAXGAINBOS,AGCMAXGAINBOS,settings
//        val mode = IntArray(1)
