...
object Const {
    ...
    var RESTART_USB = 1000
    var HANDLE_CONNECT = 10001
    var HANDLE_REGISTER = 10002
    var SHOW_LOADING = 1003
    var HIDE_LOADING = 1004
    var SHOW_RESTART_MESSAGE = 1005
    var HIDE_LOADING_FINISH = 1006
...
//    public static final int CAMERA_ID = CameraController.CAMERA_BEHIND;
    ...
    val INFISENSE_SAVE_DIR = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).toString() +
