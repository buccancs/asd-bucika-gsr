...
class ThermalInputDialog : Dialog {
    ...
    class Builder {
        ...
        fun create(): ThermalInputDialog {
            ...
            messageText = view.findViewById<View>(R.id.dialog_tip_msg_text)
            successBtn = view.findViewById<View>(R.id.dialog_tip_success_btn)
            cancelBtn = view.findViewById<View>(R.id.dialog_tip_cancel_btn)
            upEdit = view.findViewById<View>(R.id.dialog_up_edit)
            downEdit = view.findViewById<View>(R.id.dialog_down_edit)
            upUnit = view.findViewById<View>(R.id.dialog_up_unit_text)
            downUnit = view.findViewById<View>(R.id.dialog_down_unit_text)
            colorPickerView = view.findViewById<View>(R.id.color_picker_view)
            recycler = view.findViewById<View>(R.id.color_picker_recycler)
...
//                }
            ...
            view.dialog_up_color.setOnClickListener {
                dialog!!.action = 201
                view.findViewById<View>(R.id.color_picker_view_lay).visibility = View.VISIBLE
                view.findViewById<View>(R.id.dialog_input_lay).visibility = View.GONE
